...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            skills: ["Red Hat Linux", "Linux Administration", "C++", "C#", "Data Structures", "Web Development"],
            projects: ["hritikmunde-personal-portfolio", "movie-review-system", "venture-for-startups", "automatic-query-expansion"],
            interests: ["Software Engineering", "Computer Networking", "CyberSecurity"],
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">hritik@voldemort</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/hritik")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-hritik, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-hritik":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-hritik");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-hritik, todoist, trash, settings, sendmsg ]";
                }
                break;
